...
export default function Footer({ locale, dict }: FooterProps) {
  ...
  const serviceLinks = services.map((service) => ({
    ...
    label: dict.services[service.id as keyof typeof dict.services] &&
      typeof dict.services[service.id as keyof typeof dict.services] === 'object'
      ? (dict.services[service.id as keyof typeof dict.services] as { title: string }).title
      : service.id,
  }));
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
              <Image src="/logo.jpeg" alt={isRtl ? COMPANY.nameAr : COMPANY.name} width={48} height={48} className="w-12 h-12 rounded-lg object-cover" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm">
                <svg className="w-4 h-4 text-whatsapp flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center gap-2 text-sm">
                ...
                <span>{isRtl ? COMPANY.locationAr : COMPANY.location}</span>
              </li>
            </ul>
