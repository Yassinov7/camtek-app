...
export default function WhatsAppButton({ locale }: WhatsAppButtonProps) {
  ...
  return (
    <motion.a
      ...
      className={`fixed bottom-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-whatsapp text-white shadow-lg hover:bg-green-500 transition-all duration-300 ${
